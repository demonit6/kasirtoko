...
<div class="table-responsive" style="padding: 20px;">
	<table id="tb-barang" class="table table-sm table-hover table-striped table-bordered" style="width: 100%;">
		<thead>
			<tr>
				<th>Nomor</th>
				<th>Id</th>
...
<div class="my-form-controller" id="tambah-form">
	<div class="my-form-controller-scroll">
		<div class="my-form-controller-wrapper">
			...
			<form action="<?= base_url('master_barang/tambah') ?>" method="post">
				<div class="form-row form-group">
					<div class="col">
						<label>Nama</label>
						<input <?php autoff() ?> type="text" name="nama" id="autofocus" class="form-control" placeholder="Masukan nama barang">
					</div>
				</div>
				<div class="form-row form-group">
					<div class="col">
						...
						<select name="jenis" class="form-control">
							<?php
								foreach ($master_barang_jenis as $key => $value) {
									echo '<option>';
									echo $value['nama'];
									echo '</option>';
								}
...
<div class="my-form-controller" id="ubah-form">
	<div class="my-form-controller-scroll">
		<div class="my-form-controller-wrapper">
			...
			<form action="<?= base_url('master_barang/ubah') ?>" method="post">
				<input type="hidden" name="id" id="id">
				<div class="form-row form-group">
					<div class="col">
						<label>Nama</label>
						<input <?php autoff() ?> type="text" name="nama" id="nama" class="form-control" placeholder="Masukan nama barang">
					</div>
				</div>
				<div class="form-row form-group">
					<div class="col">
